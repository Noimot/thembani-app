...
export const Sidebar = () => {
  ...
  return (
    <aside className="h-screen w-272 shadow-4xl bg-green-2 pt-6 px-8">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M0 7.10329L9 0.75L18 7.10329V19.9105H10.4211V15.1737H7.57895V19.9105H0V7.10329ZM12.3158 18.0158H16.1053V8.08618L9 3.07105L1.89474 8.08618V18.0158H5.68421V13.2789H12.3158V18.0158ZM6.15789 9.01579C6.15789 7.44967 7.43388 6.17368 9 6.17368C10.5661 6.17368 11.8421 7.44671 11.8421 9.01579C11.8421 10.5819 10.5661 11.8579 9 11.8579C7.43388 11.8579 6.15789 10.5819 6.15789 9.01579ZM7.57895 9.01579C7.57895 9.80033 8.21546 10.4368 9 10.4368C9.78454 10.4368 10.4211 9.80033 10.4211 9.01579C10.4211 8.23125 9.78454 7.59474 9 7.59474C8.21546 7.59474 7.57895 8.23125 7.57895 9.01579Z" fill="#009B72"/>
</svg>
          ...
          <li className="">
            <CustomLink onClick={handleNavigateToTop} to="/dashboard/loan-application">
              <span className="flex items-center gap-x-3">
                <span>
          ...
          <li className="">
            <CustomLink onClick={handleNavigateToTop} to="/dashboard/loan-details">
              <span className="flex items-center gap-x-3">
                <span>
