...
export default function PasswordChange() {
  ...
  const { changePasswordData, isLoading } = useSelector((state) => state.auth);
          ...
          <form>
            <div className="flex flex-col gap-[9px]">
              <label>
                <input
                  className={`${
                    errorOldP ? " border border-red-4" : ""
                  } w-1/2 h-full bg-grey-1 outline-0 text-sm placeholder:text-dark-3 text-dark-3 px-[20px] py-[12px] rounded-5`}
                  type="text"
                  name="password0"
                  id="password0"
              ...
              <label>
                <input
                  className={`${
                    errorPassword ? " border border-red-4" : ""
                  } w-1/2 h-full bg-grey-1 outline-0 text-sm placeholder:text-dark-3 text-dark-3 px-[20px] py-[12px] rounded-5`}
                  type="password"
                  name="password1"
                  id="password1"
              ...
              <label>
                <input
                  className={`${
                    errorConfirmP ? " border border-red-4" : ""
                  } w-1/2 h-full bg-grey-1 outline-0 text-sm placeholder:text-dark-3 text-dark-3 px-[20px] py-[12px] rounded-5`}
                  type="password"
                  name="password2"
                  id="password2"
                  placeholder="Confirm Password"
                  onChange={handleChangeConfirmP}
                  value={confirmP}
                />
                <p className="text-sm font-medium text-dark-1">
                  {errorConfirmP}
            ...
            <div className="w-200 h-62 mt-[28px]">
              <Button
                btnText="Submit"
                btnType="submit"
                loading={isLoading}
